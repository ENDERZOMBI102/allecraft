package skyblockagesutils.world.generation.generators;
...
public class WorldGenTreeRubber extends WorldGenAbstractTree
{
	public static final IBlockState LOG = ModBlocks.rubberLog.getDefaultState();
	public static final IBlockState LEAF = ModBlocks.rubberLeaves.getDefaultState();
	
	private final int minHeight;
	
	public WorldGenTreeRubber()
	{
		super(false);
		this.minHeight = 12;
	}
	...
	public boolean generate(World world, Random rand, BlockPos pos)
	{
		...
		else
		{
			...
			boolean isSoil = state.getBlock().canSustainPlant(state, world, down, EnumFacing.UP, (IPlantable) ModBlocks.rubberSapling);
